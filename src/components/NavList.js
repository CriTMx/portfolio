...
function NavList()
{
    return (
        ...
        <div className="collapse navbar-collapse" id="navbarSupportedContent">
            <ul className="navbar-nav nav-pills ms-2 gap-md-1 gap-0">
                ...
                <li className="nav-item">
                    <a className="nav-link" href="#projects" id="textLink">Projects</a>
                </li>
                <li className="nav-item">
                    <a className="nav-link" href="#skills" id="textLink">Skills</a>
                </li>
            </ul>
            <ul className="navbar-nav ms-auto icon-list">
                ...
                <li className="nav-item">
                    <a className="nav-link icon-svg" href="#" data-tooltip-id="tooltip-id-2" data-tooltip-content="critmx, CriTMx#0677"><IconDiscord /></a>
                </li>
                <li className="nav-item">
            ...
            <Tooltip id="tooltip-id-2" place='bottom'/>
        </div>
    )
}
